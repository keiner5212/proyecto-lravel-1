...
@section('content')
    ...
    <div class="container mt-6">
        <h1 class="raceTitle">Ets federat? (PRO)</h1>
        <a href="{{ route('showInscriptionOfRacePro', $race['id']) }}"><div  class="btn btn-primary customButtonLogin">Si</div></a>
        <a href="{{ route('showInscriptionOfRaceOpen', $race['id']) }}"><div  class="btn btn-primary customButtonLogin">No</div></a>
    </div>
